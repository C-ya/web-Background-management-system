<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manage.aspx.cs" Inherits="web1.manage" %>
            ...
            <div class="wrapper">
                ...
                <div class="white-box">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="TextBox1" runat="server" MaxLength="9" ReadOnly="True"></asp:TextBox>
                    </div>
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label2" runat="server" Text="旧密码" Width="50px"></asp:Label>
                        <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>

                    </div>
                    <div class="form-group">
                        <asp:Label ID="Label4" runat="server" Text="新密码" Width="50px"></asp:Label>
