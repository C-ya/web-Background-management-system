...
namespace web1
{
    ...
    {
        public const string connectionString = "Data Source=.;Pooling=False;Max Pool Size = 1024;Initial Catalog=jxgl;Persist Security Info=True;User ID=sa;Password=123456";
