<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addteach.aspx.cs" Inherits="web1.addteach" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="main-content">
            ...
            <div class="wrapper">
                ...
                <div class="white-box">
                    <h2 class="header-title">添加教师授课信息</h2>

                    <div class="form-group">
                        <asp:Label ID="Label1" runat="server" Text="教师工号" Width="60px"></asp:Label>
                        <asp:TextBox ID="TextBox1" runat="server" MaxLength="9" Width="20%"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="Label2" runat="server" Text="课号" Width="60px"></asp:Label>
