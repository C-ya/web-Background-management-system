<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addcourse.aspx.cs" Inherits="web1.addcourse" %>
                ...
                <ul class="nav nav-pills nav-stacked custom-nav">
                    ...
                    <li class="menu-list nav-active"><a href="#"><i class="icon-envelope-open"></i><span>课程信息管理</span></a>
                        <ul class="sub-menu-list">
                            ...
                            <li class="active"><a href="addcourse.aspx">添加课程信息</a></li>
                        </ul>
                    </li>
        ...
        <div class="main-content">
            ...
            <div class="wrapper">
                ...
                <div class="page-title-box">
                    <h4 class="page-title">添加课程信息</h4>
                    <ol class="breadcrumb">
                        <li>
                            <a href="#">课程信息管理</a>
                        </li>

                        <li class="active">添加课程信息
                        </li>
                    </ol>
                ...
                <div class="white-box">
                    <h2 class="header-title">添加课程信息</h2>

                    <div class="form-group">
                        <asp:Label ID="Label1" runat="server" Text="课程号" Width="50px"></asp:Label>
                        <asp:TextBox ID="TextBox1" runat="server" MaxLength="9"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="Label2" runat="server" Text="课程名" Width="50px"></asp:Label>
                        <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="Label3" runat="server" Text="学时" Width="50px"></asp:Label>
                        <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
                    </div>


                    <div class="button-wrap">
                        <asp:Button ID="Button1" runat="server" Text="确定" class="btn btn-primary" OnClick="Button1_Click" />
