<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teacher.aspx.cs" Inherits="web1.teacher" %>
    ...
    <form id="form1" runat="server">
            ...
            <div class="left-side-inner">
                ...
                <ul class="nav nav-pills nav-stacked custom-nav">
                    ...
                    <li class="menu-list nav-active"><a href="#"><i class="icon-layers"></i><span>教师信息管理</span></a>
                        <ul class="sub-menu-list">
                            <li class="active"><a href="teacher.aspx">教师信息详情</a></li>
        ...
        <div class="main-content">
            ...
            <div class="wrapper">
                ...
                <asp:GridView ID="GridView1" runat="server" OnRowCommand="GridView_OnRowCommand" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="T#" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Height="409px" Width="98%">
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <Columns>
                        <asp:BoundField DataField="T#" HeaderText="工号" ReadOnly="True" SortExpression="T#">
                        ...
                        <asp:BoundField DataField="TBIRTHIN" HeaderText="出生日期" SortExpression="TBIRTHIN" DataFormatString="{0:yyyy-MM-dd hh:mm:ss}" />
                        <asp:BoundField DataField="TITLEOF" HeaderText="职称" SortExpression="TITLEOF" />
                        <asp:BoundField DataField="TRSECTION" HeaderText="学院" SortExpression="TRSECTION" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:jxglConnectionString %>" SelectCommand="SELECT * FROM [T]"></asp:SqlDataSource>
