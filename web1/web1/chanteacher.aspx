<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chanteacher.aspx.cs" Inherits="web1.chanteacher" %>
            ...
            <div class="wrapper">
                ...
                <div class="white-box">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="TextBox4" runat="server" class="form-control" Width="20%"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="Label5" runat="server" Text="职称"></asp:Label>
                        <asp:TextBox ID="TextBox5" runat="server" class="form-control" Width="20%"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="Label6" runat="server" Text="学院"></asp:Label>
                        <asp:TextBox ID="TextBox6" runat="server" class="form-control" Width="20%"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="Label7" runat="server" Text="电话"></asp:Label>
                        <asp:TextBox ID="TextBox7" runat="server" class="form-control" Width="20%"></asp:TextBox>
                    </div>
                </div>
