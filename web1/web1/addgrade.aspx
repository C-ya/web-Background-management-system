<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addgrade.aspx.cs" Inherits="web1.addgrade" %>
    ...
    <form id="form1" runat="server">
                ...
                <ul class="nav nav-pills nav-stacked custom-nav">
                    ...
                    <li class="menu-list nav-active"><a href="#"><i class="icon-grid"></i><span>学生成绩管理</span></a>
                        <ul class="sub-menu-list">
                            ...
                            <li class="active"><a href="addstugrade.aspx">添加学生成绩</a></li>
                        </ul>
                    </li>
        ...
        <div class="main-content">
            ...
            <div class="wrapper">
                ...
                <div class="white-box">
                    <h2 class="header-title">添加学生成绩信息</h2>
