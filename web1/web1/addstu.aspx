<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addstu.aspx.cs" Inherits="web1.addstu" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="main-content">
            ...
            <div class="wrapper">
                ...
                <div class="white-box">
                    <h2 class="header-title">添加学生信息</h2>

                    <div class="form-group">
                        <asp:Label ID="Label1" runat="server" Text="学号" Width="35px"></asp:Label>
                    ...
                    <div class="form-group">
                        ...
                        <asp:RadioButton ID="RadioButton1" runat="server" Text="男" Width="50px" GroupName="group1" />
                        <asp:RadioButton ID="RadioButton2" runat="server" Text="女" Width="50px" GroupName="group1" />
                    </div>
                    <div class="form-group">
                        <asp:Label ID="Label4" runat="server" Text="出生日期"></asp:Label>
                        <asp:Calendar ID="Calendar1" runat="server" BackColor="White" BorderColor="#999999" CellPadding="4" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="180px" Width="200px" SelectedDate="1999-05-11">
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label5" runat="server" Text="籍贯" Width="35px"></asp:Label>
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label7" runat="server" Text="班级" Width="35px"></asp:Label>
