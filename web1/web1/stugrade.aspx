<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stugrade.aspx.cs" Inherits="web1.stugrade" %>
            ...
            <div class="left-side-inner">
                ...
                <ul class="nav nav-pills nav-stacked custom-nav">
                    ...
                    <li class="menu-list nav-active"><a href="#"><i class="icon-grid"></i><span>学生成绩管理</span></a>
                        <ul class="sub-menu-list">
                            <li class="active"><a href="stugrade.aspx">学生成绩详情</a></li>
        ...
        <div class="main-content">
            ...
            <div class="wrapper">
                ...
                <div class="page-title-box">
                    <h4 class="page-title">学生成绩管理</h4>
                    <ol class="breadcrumb">
                        <li>
                            <a href="#">学生成绩管理</a>
                        </li>

                        <li class="active">学生成绩信息
                        </li>
                    </ol>
                ...
                <asp:GridView ID="GridView2" runat="server" OnRowCommand="GridView_OnRowCommand" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="S#,C#" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Width="98%">
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <Columns>
                        <asp:BoundField DataField="S#" HeaderText="学号" ReadOnly="True" SortExpression="S#" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:jxglConnectionString %>" SelectCommand="SELECT * FROM [SC]"></asp:SqlDataSource>
